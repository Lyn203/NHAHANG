<%-- 
    Document   : monthit
    Created on : Oct 27, 2017, 1:07:53 AM
    Author     : NSH
--%>
...
<div style="margin-top: -18px; height: 124px; width: 100%; background-image: url(<c:url value="/resource/images/thucdon-img.PNG"/>">
        ...
        <h2 style="text-align: center; color: #5f040d; font-weight: bold;"><span style="padding-right: 5px;font-size:0.8em;color: #5f040d" class="glyphicon glyphicon-cog"></span>MÓN THỊT<span style="padding-left: 5px;font-size:0.8em;color: #5f040d" class="glyphicon glyphicon-cog"></span></h2>

        <div class="container">
            <div class="row">
                <c:forEach var="mgs" items="${lstMonThit}">
