<%-- 
    Document   : monhaisan
    Created on : Oct 27, 2017, 1:16:50 AM
    Author     : NSH
--%>
...
<html>
    ...
    <body style="background-image: url(<c:url value="/resource/images/bggoimon.png"/>)">
        ...
        <h2 style="text-align: center; color: #5f040d; font-weight: bold;"><span style="padding-right: 5px;font-size:0.8em;color: #5f040d" class="glyphicon glyphicon-cog"></span>MÓN HẢI SẢN<span style="padding-left: 5px;font-size:0.8em;color: #5f040d" class="glyphicon glyphicon-cog"></span></h2>

        <div class="container">
            <div class="row">
                <c:forEach var="mgs" items="${lstMonHaiSan}">
