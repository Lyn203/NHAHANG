<%-- 
    Document   : ThucDon
    Created on : Oct 26, 2017, 6:24:43 PM
    Author     : NSH
--%>
        ...
        <div class="navbar" style="width: 100%; margin: auto; border: none;">
            <div class="container-fluid" style="background-color: #ffe6cc;padding-left: 35%;">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="<c:url value="/MonAn/MonRau.htm"/>" style="color: black;">ĐẶT MÓN</a>
                    </li>
                </ul>
            </div>
        </div>
        <h2 style="text-align: center; color: #5f040d; font-weight: bold;"><span style="padding-right: 5px;font-size:0.8em;color: #5f040d" class="glyphicon glyphicon-cog"></span>KHAI VỊ<span style="padding-left: 5px;font-size:0.8em;color: #5f040d" class="glyphicon glyphicon-cog"></span></h2>
        <div class="container">
            <div class="row">
                <c:forEach var="mgs" items="${thucdon}">
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="margin-top: 50px; margin-bottom: 50px;">
                        ...
                        <input id="Mon_soLuong" name="Mon_soLuong" min="1" style="width: 60px" type="number" class="form-control" value="0">
                        <select id="Mon_DonVi" name="Mon_DonVi" style="width: 100px;" class="form-control">
