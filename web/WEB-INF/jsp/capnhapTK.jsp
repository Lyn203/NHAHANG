<%-- 
    Document   : capnhapTK
    Created on : Dec 4, 2017, 2:37:51 PM
    Author     : NSH
--%>
...
<html>
    ...
    <body>
        <div style="height: 124px; width: 100%; background-image: url(<c:url value="/resource/images/thucdon-img.PNG"/>);margin-top: -22px">
            <h2 style="color: #ffffff; text-align: center; line-height: 130px;">CẬP NHẬP THÔNG TIN TÀI KHOẢN</h2>
        </div>
        <s:form action="XuLyCapNhapTK.htm" commandName="capNhap" method="get">
                ...
                <table class="table table-bordered" style="border: 2px solid #ddd; width: 33%; margin: auto;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="border: none;"><s:input type="text" path="user" name="" size="30" readonly="true"/></td>
                        </tr>
                        <tr>
